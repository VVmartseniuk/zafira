...
import static com.qaprosoft.zafira.services.exceptions.ProcessingException.ProcessingErrorDetail.INVALID_FREEMARKER_TEMPLATE;
...
public class FreemarkerUtil {
    ...
    public String getFreeMarkerTemplateContent(String template, Object obj, boolean isPath) {
        ...
        try {
            ...
            throw new ProcessingException(INVALID_FREEMARKER_TEMPLATE, e.getMessage(), e);
        }
